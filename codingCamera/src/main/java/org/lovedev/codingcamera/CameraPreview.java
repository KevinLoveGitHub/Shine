...
class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private int dw, dh;
    private float rate;
	private com.camera.simplewebcam.CameraPreview mImageProc  = new com.camera.simplewebcam.CameraPreview();;
    ...
    public void run() {
        while (true && cameraExists) {
			...
			mImageProc.processCamera();
        	// camera image to bmp
			mImageProc.pixeltobmp(bmp);
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		// /dev/videox (x=cameraId + cameraBase) is used
		int ret = mImageProc.prepareCameraWithBase(cameraId, cameraBase);
