...
public abstract class BaseUIActivity extends Activity {
    ...
    public abstract boolean axisEvent(int coordType, int btnType, int action, float x, float y,
            MotionEvent event);

    public abstract boolean runLuaScript(String Script);

    public abstract boolean setImage(Bitmap image, String appName, String sceneName,
    ...
    public abstract void callBackKeyEvent(String sceneName, String objName, int action,
    ...
    public abstract boolean registerAnimToListen(String SceneName, String OldObjName,
            String NewObjName);

    public abstract boolean unRegisterListenAnim(String SceneName, String OldObjName,
            String NewObjName);

    public abstract void createDynamicTexture(int width, int height, int num_mips,
    ...
    public abstract boolean replacewithDynamicTex(String appName, String sceneName, String objName,
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (!ret) {
            ...
            // LEFT_BTN
            int btnType = 0;
            ret = axisEvent(coordType, btnType, event.getAction(), event.getX(), event.getY(),
                    event);
        }
        return ret;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        boolean ret = glView.gameEngine.keyEvent(event.getAction(), event.getUnicodeChar(),
    ...
    public class GLsurfaceViewActivity extends BaseGLSurfaceView {
        ...
        public class GameEngine {
                ...
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            ...
                            // "!! ");
                            m_bRet = BaseUIActivity.this.keyEvent(actionL, unicodeCharL, keyCodeL,
                                    eventL);
                        }
                    });
                }
            ...
            public boolean render(int drawWidth, int drawHeight, boolean forceRedraw) {
                ...
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            m_bRet = BaseUIActivity.this.render(drawWidthL, drawHeightL,
                                    forceRedrawL);
                        }
                    });
                }
            ...
            public boolean axisEvent(int coordType, int btnType, int action, float x, float y,
                ...
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            m_bRet = BaseUIActivity.this.axisEvent(coordTypeL, btnTypeL, actionL,
                                    xL, yL, eventL);
                        }
                    });
                }
                ...
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            ...
                            // ) {
                            m_bRet = BaseUIActivity.this.setImage(imageL, appNameL, sceneNameL,
                ...
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            ...
                            // != EGL10.EGL_NO_CONTEXT
                            // ) {
                            m_bRet = BaseUIActivity.this
                                    .setImage(imageL, appNameL, sceneNameL, objNameL, subEntityIDL,
            ...
            public String queryCurrentFocusApp(String SceneName, String ObjName) {
                ...
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            m_strRet = BaseUIActivity.this.queryCurrentFocusApp(SceneNameL,
                                    ObjNameL);
                        }
                    });
                }
            ...
            /*
             * public void registerCallBackString(String JavaClassName); public
             * void callBackError(int errorCode, String message); public void
             * callBackSceneChange(String OldSceneName, String NewSceneName);
             * public void callBackBlendFileChange(String OldFileName, String
             * NewFileName); public void callBackAxisEvent(int coordType, int
             * btnType, int action, float x, float y); public void
             * callBackKeyEvent(String sceneName, String objName, int action,
             * int unicodeChar, int keyCode); public void
             * callBackFocusChange(String SceneName, String OldObjName, String
             * NewObjName); public void callBackAnimDone(String SceneName,
             * String OldObjName, String NewObjName);
             */
            public boolean registerAnimToListen(String SceneName, String OldObjName,
                    String NewObjName) {
                final String SceneNameL = SceneName;
                ...
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            m_bRet = BaseUIActivity.this.registerAnimToListen(SceneNameL,
                                    OldObjNameL, NewObjNameL);
                        }
                    });
                }
                return m_bRet;
            ...
            public boolean unRegisterListenAnim(String SceneName, String OldObjName,
                    String NewObjName) {
                final String SceneNameL = SceneName;
                final String OldObjNameL = OldObjName;
                final String NewObjNameL = NewObjName;
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            m_bRet = BaseUIActivity.this.unRegisterListenAnim(SceneNameL,
                                    OldObjNameL, NewObjNameL);
                        }
                    });
                }
            ...
            public void createDynamicTexture(int width, int height, int num_mips,
                ...
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            BaseUIActivity.this.createDynamicTexture(widthL, heightL, num_mipsL,
            ...
            public boolean replacewithDynamicTex(String appName, String sceneName, String objName,
                ...
                synchronized (this) {
                    mMsEventQueue.add(new Runnable() {
                        public void run() {
                            m_bRet = BaseUIActivity.this.replacewithDynamicTex(appNameL,
                                    sceneNameL, objNameL, subEntityIDL, techIDL, passIDL, stateIDL);
                        }
                    });
                }
                return m_bRet;
        ...
        public void setOgImage(Bitmap image, String appName, String sceneName, String objName,
                int subEntityID, int techID, int passID, int stateID, boolean formatFlag) {
        ...
        private class ConfigChooser implements BaseGLSurfaceView.EGLConfigChooser {
            ...
            private int[] s_configAttribs2 = {
                    ...
                    EGL10.EGL_RENDERABLE_TYPE, EGL_OPENGL_ES2_BIT, EGL10.EGL_SAMPLE_BUFFERS, 1,
                    EGL10.EGL_SAMPLES, 4, EGL10.EGL_NONE
            };
            ...
            private void printConfig(EGL10 egl, EGLDisplay display, EGLConfig config) {
                ...
                String[] names = {
                        ...
                        "EGL_PRESERVED_RESOURCES", "EGL_SAMPLES", "EGL_SAMPLE_BUFFERS",
