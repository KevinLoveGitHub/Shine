...
public class EpgDeskImpl extends BaseDeskImpl implements EpgDesk {
    ...
    public ArrayList<EpgEventInfo> getEventInfo(short serviceType, int serviceNo, Time baseTime,
        ...
        return DtvManager.getEpgManager().getEventInfo(serviceType, serviceNo, baseTime,
                maxEventInfoCount);
    }
    ...
    public int getEventCount(short serviceType, int serviceNo, Time baseTime) {
        try {
            return DtvManager.getEpgManager().getEventCount(serviceType, serviceNo, baseTime);
        } catch (Exception e) {
    ...
    public EpgEventInfo getEventInfoByTime(short serviceType, int serviceNo, Time baseTime)
            throws Exception {
        return DtvManager.getEpgManager().getEventInfoByTime(serviceType, serviceNo, baseTime);
    }
    ...
    public EpgEventInfo getEventInfoById(short serviceType, int serviceNo, short eventID)
            throws Exception {
        return DtvManager.getEpgManager().getEventInfoById(serviceType, serviceNo, eventID);
    }
    ...
    public String getEventDescriptor(short serviceType, int serviceNumber, Time baseTime,
        ...
        return DtvManager.getEpgManager().getEventDescriptor(serviceType, serviceNumber, baseTime,
                epgDescriptionType);
    }
    ...
    public ArrayList<EpgHdSimulcast> getEventHdSimulcast(short serviceType, int serviceNo,
        ...
        return DtvManager.getEpgManager().getEventHdSimulcast(serviceType, serviceNo, baseTime,
                maxCount);
    }
    ...
    public void resetEpgProgramPriority() throws Exception {
        DtvManager.getEpgManager().resetEpgProgramPriority();
    }
    ...
    public EpgCridStatus getCridStatus(short serviceType, int serviceNumber, Time eventStartTime)
            throws Exception {
        return DtvManager.getEpgManager().getCridStatus(serviceType, serviceNumber, eventStartTime);
    }
    ...
    public ArrayList<EpgCridEventInfo> getCridSeriesList(short serviceType, int serviceNumber,
        ...
        return DtvManager.getEpgManager().getCridSeriesList(serviceType, serviceNumber,
                eventStartTime);
    }
    ...
    public ArrayList<EpgCridEventInfo> getCridSplitList(short serviceType, int serviceNumber,
            Time eventStartTime) throws Exception {
        return DtvManager.getEpgManager().getCridSplitList(serviceType, serviceNumber,
                eventStartTime);
    }
    ...
    public ArrayList<EpgCridEventInfo> getCridAlternateList(short serviceType, int serviceNumber,
            Time eventStartTime) throws Exception {
        return DtvManager.getEpgManager().getCridAlternateList(serviceType, serviceNumber,
                eventStartTime);
    }
    ...
    public ArrayList<EpgTrailerLinkInfo> getRctTrailerLink() throws Exception {
        return DtvManager.getEpgManager().getRctTrailerLink();
    }
    ...
    public ArrayList<EpgCridEventInfo> getEventInfoByRctLink(EpgTrailerLinkInfo epgTrailerLinkInfo)
            throws Exception {
        return DtvManager.getEpgManager().getEventInfoByRctLink(epgTrailerLinkInfo);
    }
    ...
    public boolean enableEpgBarkerChannel() throws Exception {
        return DtvManager.getEpgManager().enableEpgBarkerChannel();
    }
    ...
    public boolean disableEpgBarkerChannel() throws Exception {
        return DtvManager.getEpgManager().disableEpgBarkerChannel();
    }
    ...
    public int getEpgEventOffsetTime(Time utcTime, boolean isStartTime) throws Exception {
        return DtvManager.getEpgManager().getEpgEventOffsetTime(utcTime, isStartTime);
    }
    ...
    public PresentFollowingEventInfo getPresentFollowingEventInfo(short serviceType, int serviceNo,
            boolean present, EnumEpgDescriptionType descriptionType) {
        try {
            return DtvManager.getEpgManager().getPresentFollowingEventInfo(serviceType, serviceNo,
    ...
    public EpgFirstMatchHdCast getEvent1stMatchHdSimulcast(short serviceType, int serviceNo,
        ...
        return DtvManager.getEpgManager().getEvent1stMatchHdSimulcast(serviceType, serviceNo,
                baseTime);
    }
    ...
    public EpgFirstMatchHdCast getEvent1stMatchHdBroadcast(short serviceType, int serviceNo,
            Time baseTime) throws Exception {
        return DtvManager.getEpgManager().getEvent1stMatchHdBroadcast(serviceType, serviceNo,
                baseTime);
    }
    ...
    public DtvEitInfo getEitInfo(boolean bPresent) throws Exception {
        return DtvManager.getEpgManager().getEitInfo(bPresent);
    }
    ...
    public void setEpgProgramPriority(int programIndex) throws Exception {
        DtvManager.getEpgManager().setEpgProgramPriority(programIndex);
    }
    ...
    public void setEpgProgramPriority(short serviceType, int serviceNo) throws Exception {
        DtvManager.getEpgManager().setEpgProgramPriority(serviceType, serviceNo);
    }
    ...
    public int getNvodTimeShiftEventCount(short serviceType, int serviceNumber)
            throws Exception {
        return DtvManager.getEpgManager().getNvodTimeShiftEventCount(serviceType, serviceNumber);
    }
    ...
    public ArrayList<NvodEventInfo> getNvodTimeShiftEventInfo(short serviceType, int serviceNumber,
        ...
        return DtvManager.getEpgManager().getNvodTimeShiftEventInfo(serviceType, serviceNumber,
                maxEventNum, eEpgDescritionType);
    }
