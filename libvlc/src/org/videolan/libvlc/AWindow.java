    ...
    private class SurfaceHelper {
        ...
        private final SurfaceHolder.Callback mSurfaceHolderCallback = new SurfaceHolder.Callback() {
            ...
            public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
                Log.e("SetWindow","surfaceChanged:" + width + "==" + height);
            }
...
//            height = 512;
            ...
            Log.e("SetWindow","width:" + mWindowWidth + "==height:" + mWindowHeight);
        }
    }
    ...
    private void setVideoLayout(final int width, final int height, final int visibleWidth,
        ...
        Log.e("SetWidow","" + width  + "==" + height + "==" + visibleWidth + "==" + visibleHeight);
        mHandler.post(new Runnable() {
            @Override
            public void run() {
